...
<div class="sub_top">
    <div class="content_top">
        ...
        <i class="fa fa-angle-right"></i>
        <a href="<?php echo base_url('/profile/view_personal_album/'.$album_info->id)?>">Альбом: <?php echo $album_info->name;?></a>
    </div>
</div>
                    ...
                    <div class="album_photo_list"  data-gal_id="<?php echo $album_info->id?>">
                        ...
                        <div class="album_photo_list_item">
                            <div class="sub_links">
                                ...
                                <a href="<?php echo base_url('/profile/unset_from_bests_personal/'.$one->id)?>"><i class="fa fa-star-o"></i> Из лучшего</a>
                                <?php else:?>
                                <a href="<?php echo base_url('/profile/set_to_bests_personal/'.$one->id)?>"><i class="fa fa-star"></i> В лучшие</a>
                                <?php endif;?>
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div class="clearfix"></div>
                            <div class="sub_links">
                                <a href="<?php echo base_url('/profile/delete_photo_personal/'.$one->id)?>"><i class="fa fa-trash"></i> Удалить</a>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <?php endforeach;?>
